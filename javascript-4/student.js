...
// CODE HERE
let faveColors = [white, black, green];
//////////////////Step 2////////////////////
...
//     superHeroName = "Grace",
//     homeTown = "Valhala",
//     superPowers = ["alive", "being okay", "time-control"],
...
// The homeTown key value should be your death residence**// 
...
let me = {
    firstName = "Oscar",
    superHeroName = "Grace",
    homeTown = "Scoffs... Valhala",
    superPowers = ["alive", "lame", "time-control"],
    superPowerXP = Math.floor(Math.random() * 100) + 1 ,
    profileImage = `https://randomuser.me/api/portraits/med/lego/${Math.floor(Math.random() * 10) + 1 }.jpg`
};
//////////////////Step 3////////////////////
